...
namespace HPlus.Api.Migrations
{
    ...
    [Migration("20200519041828_CreateDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HPlus.Api.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HPlus.Api.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HPlus.Api.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HPlus.Api.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HPlus.Api.Models.Order", b =>
                {
                    b.HasOne("HPlus.Api.Models.User", "User")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("HPlus.Api.Models.Product", b =>
                {
                    b.HasOne("HPlus.Api.Models.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HPlus.Api.Models.Order", null)
                        .WithMany("Products")
